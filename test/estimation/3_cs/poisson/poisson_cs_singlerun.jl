...
# design Matrix
Random.seed!(1234)
Xstack = [randn(ni, p - 1) for i in 1:samplesize]
...
@show gcm.ρ
@show gcm.σ2
fittime = @elapsed GLMCopula.fit!(gcm, IpoptSolver(print_level = 5, max_iter = 100, tol = 10^-8, limited_memory_max_history = 20, accept_after_max_steps = 3, hessian_approximation = "limited-memory"))
@show gcm.β
@show gcm.ρ
@show gcm.σ2
...
@show gcm.θ
@show gcm.∇θ
loglikelihood!(gcm, true, true) # -9350.156947345826
vcov!(gcm)
