    ...
    for k in 1:length(ns)
        ...
        for j in 1:nsims
            ...
            try 
                ...
                fittime_GLMM = @elapsed gm1 = fit(MixedModel, form, df, Bernoulli())
                display(gm1)
                @show gm1.β
...
writedlm("mse_Sigma_logistic_GLMM_" * ftail, ΣMseResults_GLMM, ',')
writedlm("fittimes_logistic_GLMM_" * ftail, fittimes_GLMM, ',')
