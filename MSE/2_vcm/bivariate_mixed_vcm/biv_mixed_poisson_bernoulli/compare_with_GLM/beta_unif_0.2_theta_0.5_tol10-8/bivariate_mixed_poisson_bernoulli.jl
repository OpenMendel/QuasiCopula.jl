...
#                 fittime = @elapsed GLMCopula.fit!(gcm, IpoptSolver(print_level = 5, max_iter = 100, tol = 10^-8, warm_start_init_point="yes", limited_memory_max_history = 50, accept_after_max_steps = 5, hessian_approximation = "limited-memory"))
                fittime = @elapsed GLMCopula.fit!(gcm, IpoptSolver(print_level = 5, max_iter = 100, tol = 10^-8, warm_start_init_point="yes", limited_memory_max_history = 16, hessian_approximation = "limited-memory"))
                @show fittime
                @show gcm.β
                @show gcm.Σ
                @show gcm.θ
